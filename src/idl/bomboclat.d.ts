...
export type Bomboclat = {
    ...
    "errors": [
        ...
        {
            "code": 6034;
            "name": "noTokensToSweep";
            "msg": "No tokens to sweep";
        },
        {
            "code": 6035;
        ...
        },
        {
            ...
            "msg": "Fees must be distributed before sweeping unclaimed funds";
        },
        {
            "code": 6046;
            "name": "tokensNotYetBurned";
            "msg": "Tokens have not been burned yet";
        }
    ];
    "types": [
        {
...
//# sourceMappingURL=bomboclat.d.ts.map